...
Poté, co je získána kolekce $Results$, je možné výsledky filtrovat a řadit. Filtrování je možné pomocí $NSPredicate$. \cite{realmDocs} $NSPredicate$ je třída obsažená v knihovně $Foundation$ (oficiální knihovna Apple), která představuje podmínku, jenž může být použita pro filtrování nad kolekcemi objektů. $NSPredicate$ může obsahovat klíčová slova -- like, between, contains, and, or a mnohé další. \cite{predicate}
...
% prihlasovaci moznosti, zadavani credetetians neni prilis pohodlne na mobilnim zarizeni (pojednava clanek ...), prihlasovani pomoci cloudkit
