...
\item Safelog Pilot Logbook -- druhá iOS aplikace, také v angličtině, vytvořená Dauntless Software. \cite{appStoreSafeLog}
\item Logbook Pro Aviation Flight Log for Pilots -- poslední z analyzovaných iOS aplikací. I tato aplikace je v anglickém jazyce. Publikována NC Software, Inc. \cite{appStoreLogbookPro}
