...
Heuristická analýza byla provedena znovu poté, co byla aplikace implementována do stavu tzv. beta verze. I tato heuristická analýze byla prováděna podle pravidel Jakoba Nielsena a nyní již bylo zohledněno všech deset pravidel. Všechny nalezené chyby byly, stejně jako u předchozí heuristické analýzy, ohodnoceny na stupnici 1--5, kde číslo 1 identifikuje pouze drobný problém a číslo 5 velice závažný problém. U všech nalezených problémů je také uvedeno řešení, pomocí kterého byly chyby opraveny. Nakonec tabulka \ref{tab:heu_eval_2} zobrazuje u každého pravidla zda bylo porušeno a jaká byla maximální závažnost porušení tohoto pravidla.
...
Všechny testy byly nahrávány z důvodu možné zpětné analýzy nedostatků aplikace. Všechny nahrávky testů jsou k nalezení v příloze této magisterské práce.
...
%seq + sus
%vlastni hodnoceni kazdeho scenare kazdeho uzivatele (1-5)
