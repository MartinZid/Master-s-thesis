...
\section{EASA a předpisy}
Limity, certifikáty, evidence letu ...
...
Při vkládání záznamu jsou brány v potaz pouze doplňkové položky, protože aplikace bude tvořena podle předpisu EASA FCL.050 \url{www.easa.europa.eu/system/files/dfu/Part-FCL.pdf}, který udává povinné údaje při evidování letu. Také položka v hodnocení  -- reporty podle EASA, je analyzována z pohledu předpisu FCL.050. 
